Ext.application({
    ...
    requires: ['Ext.data.Store', 'Ext.MessageBox', 'Ext.List', 'Ext.field.Search', 'Ext.Toolbar', 'Ext.Panel', 'Ext.Button', 'Ext.Map', 'Ext.plugin.google.Traffic', 'Ext.plugin.google.Tracker'
    ...
    launch: function() {
...

        {
...

            {
                ...
                width: 'auto',
                height: 'auto',
                html: 'Welcome, Select a Doctor name from the list to diplay information',
                //hide
                items: [
    ...
    getTap: function(view, index, item, e) {
        ...
        var body = 'Doctors name: Dr. Tommy Maintz <br> Government employee: Yes <br> State : Delhi <br> City: New Delhi <br> Services : <br> Ambulance : No <br> Pharmacy : No';
